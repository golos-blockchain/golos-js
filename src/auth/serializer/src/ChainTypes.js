...
ChainTypes.operations = {
  ...
  fill_convert_request: 65,
  author_reward: 66,
  curation_reward: 67,
  comment_reward: 68,
  liquidity_reward: 69,
  interest: 70,
  fill_vesting_withdraw: 71,
  fill_order: 72,
  shutdown_witness: 73,
  fill_transfer_from_savings: 74,
  hardfork: 75,
  comment_payout_update: 76,
  comment_benefactor_reward: 77,
  return_vesting_delegation: 78,
  producer_reward: 79,
  delegation_reward: 80,
  auction_window_reward: 81,
};
